...
def convertTimeStrDT(string):
    """
    Converts string input time to 
    """
...
#def addTimeAsDateTime(list1, delta):
#    """
#    Add time to drones to update their information
#
#    Requires: the lists of lists of drones and a delta given by parcels information: int >= 0
...
def checkTime(list1, delta):
    ...
    if not, does nothing to the list
    ...
    """
    if addTimeAsString(list1, delta)[1] > convertTime(list1):
